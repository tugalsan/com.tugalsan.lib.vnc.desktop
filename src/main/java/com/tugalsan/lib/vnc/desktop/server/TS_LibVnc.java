...
public class TS_LibVnc {
    ...
    public static Viewer show(TS_ThreadSyncTrigger killTrigger, JDesktopPane pane, Window window, Parser parser) {
        return new Viewer(killTrigger, parser, pane, window);
    }

    public static void connect(TS_ThreadSyncTrigger killTrigger, JDesktopPane pane, Window window, Parser parser) {
        show(killTrigger, pane, window, parser).connectAction();
    }

    public static Viewer show(TS_ThreadSyncTrigger killTrigger, JDesktopPane pane, Window window, boolean viewOnly, String ipNumber_orURL, String password) {
